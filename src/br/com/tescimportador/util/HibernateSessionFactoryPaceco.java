...
public class HibernateSessionFactoryPaceco {
	static Logger LOG = Logger.getLogger(HibernateSessionFactoryPaceco.class.getName());

	private static SessionFactory sessionFactory;

	private static String CAMINHO_CLASSES = JbossUtil.getClassesPath();

	private static final String PACKAGE_VIEWS = "br.com.tesc.tescweb.paceco.views";
